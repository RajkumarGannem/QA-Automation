...
public class CreateUserTestScript {
	...
	public void init() {
		...
		public void CreateUserAccountwithdetails() throws InterruptedException  {
			   ...
			   userService.insertPhoneNumber(appData.get(0).getTitle(),appData.get(0).getGender());
			   userService.GeneratePassword(appData.get(0).getPassWord(),appData.get(0).getPasswordConfirm());
