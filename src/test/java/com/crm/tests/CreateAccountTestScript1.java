...
public class CreateAccountTestScript1 {
	...
	@Test(description = "This textcase creates account without name")
	public void createAccountWithBillingAddressAndShippingAddress() throws InterruptedException {
		...
		accountService.insertEmtpyName(appData.get(0).getEmptyName());
